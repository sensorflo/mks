...
;; ?? viewsandbox, memberinfo, ...
;; si (print|rlog|viewhistory) are similar but with different defaults
;; 
;; $ si print prestank.cpp 
;; source/prestank.cpp 1.13 archive
;;
;;
;;
;; $ si viewhistory prestank.cpp
;; /home/emp8118035/prog/m/drivers_dev/dispensehandling/source/prestank.cpp
;; 1.13    Florian Kaufmann (flka) Nov 16, 2010 1:35:00 PM         Exp          - corrected literals which where not yet in SI units (Dragon legacy...)
;; 1.12    Florian Kaufmann (flka) Nov 11, 2010 4:09:17 PM         Exp     dailybuild    - added methods setVacPressure setPresSetting syringeWasExchanged setPresCorrMode
;; 1.11    Florian Kaufmann (flka) Nov 5, 2010 10:19:30 AM         Exp          - calling createPosList , doDispense from within mushell now works
;; 1.10    Florian Kaufmann (flka) Oct 29, 2010 1:35:29 PM         Exp          - bug in vactank - hose simulation
;; - PulseSeq GetReady now also ensures that the PresTank pressure is ok
;;
;;
;;
;; $ si rlog prestank.cpp
;; member name: source/prestank.cpp;       working file: /home/emp8118035/prog/m/drivers_dev/dispensehandling/source/prestank.cpp
;; head:   1.13
;; member: 1.13
;; branch:
;; locks:
;; 
;; attributes:
;; symbolic names:         dailybuild:1.12
;; file format: text
;; revision storage: reverse deltas
;; total revisions: 13; branches: 0; branch revisions: 0
;; description:
;; - creation
;; -----------------------
;; revision 1.13
;; date: Nov 16, 2010 1:35:00 PM; author: Florian Kaufmann (flka); state: Exp; lines: +2 -2
;; change package: 52737:2 driver impl
;; - corrected literals which where not yet in SI units (Dragon legacy...)
;; -----------------------
;; revision 1.12
;; labels: dailybuild
;; date: Nov 11, 2010 4:09:17 PM; author: Florian Kaufmann (flka); state: Exp; lines: +63 -57
;; change package: 52737:2 driver impl
;; - added methods setVacPressure setPresSetting syringeWasExchanged setPresCorrMode
;;
;;
;; $ si memberinfo prestank.cpp
;; Member Name: /home/emp8118035/prog/m/drivers_dev/dispensehandling/source/prestank.cpp
;; Sandbox Name: /home/emp8118035/prog/m/drivers_dev/dispensehandling/dispensehandling.pj
;; Development Branch: 1
;; Member Revision: 1.13
;;     Created By: Florian Kaufmann (flka) on Nov 16, 2010 1:35:00 PM CET
;;     State: Exp
;;     Revision Description:
;;         - corrected literals which where not yet in SI units (Dragon
;;         legacy...)
;;     Labels: none
;;     Change Package:
;;         ID: 52737:2
